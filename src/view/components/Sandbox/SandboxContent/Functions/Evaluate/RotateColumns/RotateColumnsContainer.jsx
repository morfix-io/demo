...
class RotateColumnsContainer extends PureComponent {
  constructor(props) {
    super(props)
    this.state = {
  ...
  _constructAction = () => {
    const { morfixEvaluateRotateColumnsRequest } = this.props

    const { cipherTextIdA, cipherTextIdDestination } = this.state

    return {
      action: morfixEvaluateRotateColumnsRequest,
      payload: {
        cipherTextIdA,
          ...
          >
            ...
            <Grid item>
              <TextField
                ...
                helperText={intl.formatMessage({ id: 'ciphertext_destination_description_rotate_columns' })}
                className={classes.textField}
            ...
            <Grid item>
              ...
              >
                <Typography variant="button" display="block">
                  {intl.formatMessage({ id: 'rotate_columns' })}
                </Typography>
              </Button>
            </Grid>
          </Grid>
...
RotateColumnsContainer.propTypes = {}

export default compose(withStyles(styles), withConstants, injectIntl)(RotateColumnsContainer)
