...
class DotProductContainer extends PureComponent {
  constructor(props) {
    super(props)
    this.state = {
  ...
  _constructAction = () => {
    const { morfixEvaluateDotProductRequest } = this.props

    const { cipherTextIdA, cipherTextIdB, cipherTextIdDestination } = this.state

    return {
      action: morfixEvaluateDotProductRequest,
      payload: {
        cipherTextIdA,
        cipherTextIdB,
            ...
            <Grid item>
              ...
              >
                <Typography variant="button" display="block">
                  {intl.formatMessage({ id: 'dot_product' })}
                </Typography>
              </Button>
            </Grid>
          </Grid>
...
DotProductContainer.propTypes = {}

export default compose(withStyles(styles), withConstants, injectIntl)(DotProductContainer)
