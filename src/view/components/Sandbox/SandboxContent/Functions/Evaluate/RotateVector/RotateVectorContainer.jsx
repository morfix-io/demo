...
class RotateVectorContainer extends PureComponent {
  constructor(props) {
    super(props)
    this.state = {
  ...
  _constructAction = () => {
    const { morfixEvaluateRotateVectorRequest } = this.props

    const { cipherTextIdA, steps, cipherTextIdDestination } = this.state

    return {
      action: morfixEvaluateRotateVectorRequest,
      payload: {
        cipherTextIdA,
        steps,
          ...
          >
            ...
            <Grid item>
              <TextField
                ...
                helperText={intl.formatMessage({ id: 'ciphertext_destination_description_rotate_vector' })}
                className={classes.textField}
            ...
            <Grid item>
              ...
              >
                <Typography variant="button" display="block">
                  {intl.formatMessage({ id: 'rotate_vector' })}
                </Typography>
              </Button>
            </Grid>
          </Grid>
...
RotateVectorContainer.propTypes = {}

export default compose(withStyles(styles), withConstants, injectIntl)(RotateVectorContainer)
