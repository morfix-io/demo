...
class CipherModulusSwitchToNextContainer extends PureComponent {
  constructor(props) {
    super(props)
    this.state = {
  ...
  _constructAction = () => {
    const { morfixEvaluateCipherModulusSwitchToNextRequest } = this.props

    const { cipherTextIdA, cipherTextIdDestination } = this.state

    return {
      action: morfixEvaluateCipherModulusSwitchToNextRequest,
      payload: {
        cipherTextIdA,
          ...
          >
            ...
            <Grid item>
              <TextField
                ...
                helperText={intl.formatMessage({ id: 'ciphertext_destination_description_cipher_mod_switch_to_next' })}
                className={classes.textField}
            ...
            <Grid item>
              ...
              >
                <Typography variant="button" display="block">
                  {intl.formatMessage({ id: 'cipher_mod_switch_to_next' })}
                </Typography>
              </Button>
            </Grid>
          </Grid>
...
CipherModulusSwitchToNextContainer.propTypes = {}

export default compose(withStyles(styles), withConstants, injectIntl)(CipherModulusSwitchToNextContainer)
