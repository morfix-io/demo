...
class MultiplyCipherByPlainContainer extends PureComponent {
  constructor(props) {
    super(props)
    this.state = {
  ...
  _constructAction = () => {
    const { morfixEvaluateMultiplyCipherByPlainRequest } = this.props

    const { cipherTextIdA, plainTextIdB, cipherTextIdDestination } = this.state

    return {
      action: morfixEvaluateMultiplyCipherByPlainRequest,
      payload: {
        cipherTextIdA,
        plainTextIdB,
            ...
            <Grid item>
              ...
              >
                <Typography variant="button" display="block">
                  {intl.formatMessage({ id: 'multiply_cipher_by_plain' })}
                </Typography>
              </Button>
            </Grid>
          </Grid>
...
MultiplyCipherByPlainContainer.propTypes = {}

export default compose(withStyles(styles), withConstants, injectIntl)(MultiplyCipherByPlainContainer)
