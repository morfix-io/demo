...
class CipherTransformFromNTTContainer extends PureComponent {
  constructor(props) {
    super(props)
    this.state = {
  ...
  _constructAction = () => {
    const { morfixEvaluateCipherTransformFromNTTRequest } = this.props

    const { cipherTextIdA, cipherTextIdDestination } = this.state

    return {
      action: morfixEvaluateCipherTransformFromNTTRequest,
      payload: {
        cipherTextIdA,
          ...
          >
            ...
            <Grid item>
              <TextField
                ...
                helperText={intl.formatMessage({ id: 'ciphertext_destination_description_cipher_transform_from_ntt' })}
                className={classes.textField}
            ...
            <Grid item>
              ...
              >
                <Typography variant="button" display="block">
                  {intl.formatMessage({ id: 'cipher_transform_from_ntt' })}
                </Typography>
              </Button>
            </Grid>
          </Grid>
...
CipherTransformFromNTTContainer.propTypes = {}

export default compose(withStyles(styles), withConstants, injectIntl)(CipherTransformFromNTTContainer)
