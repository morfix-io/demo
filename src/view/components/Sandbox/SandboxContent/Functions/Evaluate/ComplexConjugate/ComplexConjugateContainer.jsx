...
class ComplexConjugateContainer extends PureComponent {
  constructor(props) {
    super(props)
    this.state = {
  ...
  _constructAction = () => {
    const { morfixEvaluateComplexConjugateRequest } = this.props

    const { cipherTextIdA, cipherTextIdDestination } = this.state

    return {
      action: morfixEvaluateComplexConjugateRequest,
      payload: {
        cipherTextIdA,
          ...
          >
            ...
            <Grid item>
              <TextField
                ...
                helperText={intl.formatMessage({ id: 'ciphertext_destination_description_complex_conjugate' })}
                className={classes.textField}
            ...
            <Grid item>
              ...
              >
                <Typography variant="button" display="block">
                  {intl.formatMessage({ id: 'complex_conjugate' })}
                </Typography>
              </Button>
            </Grid>
          </Grid>
...
ComplexConjugateContainer.propTypes = {}

export default compose(withStyles(styles), withConstants, injectIntl)(ComplexConjugateContainer)
