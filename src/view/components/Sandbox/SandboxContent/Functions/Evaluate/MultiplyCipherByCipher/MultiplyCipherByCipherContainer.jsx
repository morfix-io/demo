...
class MultiplyCipherByCipherContainer extends PureComponent {
  constructor(props) {
    super(props)
    this.state = {
  ...
  _constructAction = () => {
    const { morfixEvaluateMultiplyCipherByCipherRequest } = this.props

    const { cipherTextIdA, cipherTextIdB, cipherTextIdDestination } = this.state

    return {
      action: morfixEvaluateMultiplyCipherByCipherRequest,
      payload: {
        cipherTextIdA,
        cipherTextIdB,
          ...
          >
            ...
            <Grid item>
              <TextField
                ...
                helperText={intl.formatMessage({ id: 'ciphertext_destination_description_multiply' })}
                className={classes.textField}
            ...
            <Grid item>
              ...
              >
                <Typography variant="button" display="block">
                  {intl.formatMessage({ id: 'multiply_cipher_by_cipher' })}
                </Typography>
              </Button>
            </Grid>
          </Grid>
...
MultiplyCipherByCipherContainer.propTypes = {}

export default compose(withStyles(styles), withConstants, injectIntl)(MultiplyCipherByCipherContainer)
