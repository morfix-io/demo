...
class SubCipherFromCipherContainer extends PureComponent {
  constructor(props) {
    super(props)
    this.state = {
  ...
  _constructAction = () => {
    const { morfixEvaluateSubCipherFromCipherRequest } = this.props

    const { cipherTextIdA, cipherTextIdB, cipherTextIdDestination } = this.state

    return {
      action: morfixEvaluateSubCipherFromCipherRequest,
      payload: {
        cipherTextIdA,
        cipherTextIdB,
            ...
            <Grid item>
              ...
              >
                <Typography variant="button" display="block">
                  {intl.formatMessage({ id: 'sub_cipher_from_cipher' })}
                </Typography>
              </Button>
            </Grid>
          </Grid>
...
SubCipherFromCipherContainer.propTypes = {}

export default compose(withStyles(styles), withConstants, injectIntl)(SubCipherFromCipherContainer)
