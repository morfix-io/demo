...
class AddPlainToCipherContainer extends PureComponent {
  constructor(props) {
    super(props)
    this.state = {
  ...
  _constructAction = () => {
    const { morfixEvaluateAddPlainToCipherRequest } = this.props

    const { cipherTextIdA, plainTextIdB, cipherTextIdDestination } = this.state

    return {
      action: morfixEvaluateAddPlainToCipherRequest,
      payload: {
        cipherTextIdA,
        plainTextIdB,
            ...
            <Grid item>
              ...
              >
                <Typography variant="button" display="block">
                  {intl.formatMessage({ id: 'add_plain_to_cipher' })}
                </Typography>
              </Button>
            </Grid>
          </Grid>
...
AddPlainToCipherContainer.propTypes = {}

export default compose(withStyles(styles), withConstants, injectIntl)(AddPlainToCipherContainer)
