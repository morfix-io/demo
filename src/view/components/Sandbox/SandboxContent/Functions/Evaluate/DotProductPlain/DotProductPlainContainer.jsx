...
class DotProductPlainContainer extends PureComponent {
  constructor(props) {
    super(props)
    this.state = {
  ...
  _constructAction = () => {
    const { morfixEvaluateDotProductPlainRequest } = this.props

    const { cipherTextIdA, plainTextIdB, cipherTextIdDestination } = this.state

    return {
      action: morfixEvaluateDotProductPlainRequest,
      payload: {
        cipherTextIdA,
        plainTextIdB,
  ...
  render() {
    const { classes, intl, cipherTexts, plainTexts, isEvaluatorReady } = this.props
          ...
          >
            ...
            <Grid item>
              <TextField
                ...
                helperText={intl.formatMessage({ id: 'ciphertext_destination_description_dot_product' })}
                className={classes.textField}
            ...
            <Grid item>
              ...
              >
                <Typography variant="button" display="block">
                  {intl.formatMessage({ id: 'dot_product_plain' })}
                </Typography>
              </Button>
            </Grid>
          </Grid>
...
DotProductPlainContainer.propTypes = {}

export default compose(withStyles(styles), withConstants, injectIntl)(DotProductPlainContainer)
