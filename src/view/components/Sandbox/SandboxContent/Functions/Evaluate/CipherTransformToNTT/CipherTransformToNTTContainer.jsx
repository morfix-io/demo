...
class CipherTransformToNTTContainer extends PureComponent {
  constructor(props) {
    super(props)
    this.state = {
  ...
  _constructAction = () => {
    const { morfixEvaluateCipherTransformToNTTRequest } = this.props

    const { cipherTextIdA, cipherTextIdDestination } = this.state

    return {
      action: morfixEvaluateCipherTransformToNTTRequest,
      payload: {
        cipherTextIdA,
          ...
          >
            ...
            <Grid item>
              <TextField
                ...
                helperText={intl.formatMessage({ id: 'ciphertext_destination_description_cipher_transform_to_ntt' })}
                className={classes.textField}
            ...
            <Grid item>
              ...
              >
                <Typography variant="button" display="block">
                  {intl.formatMessage({ id: 'cipher_transform_to_ntt' })}
                </Typography>
              </Button>
            </Grid>
          </Grid>
...
CipherTransformToNTTContainer.propTypes = {}

export default compose(withStyles(styles), withConstants, injectIntl)(CipherTransformToNTTContainer)
