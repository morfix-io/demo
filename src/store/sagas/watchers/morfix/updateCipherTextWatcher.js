...
import { MORFIX_UPDATE_CIPHER_TEXT_REQUEST } from 'store/constants/morfix'

export default function* updateCipherTextWatcher() {
  const workers = yield getContext('workers')
  const throttleChannel = yield actionChannel(MORFIX_UPDATE_CIPHER_TEXT_REQUEST, buffers.sliding(1))
  ...
  while (true) {
    ...
    lastTask = yield fork(workers.morfix.updateCipherTextWorker, action)
  }
}
