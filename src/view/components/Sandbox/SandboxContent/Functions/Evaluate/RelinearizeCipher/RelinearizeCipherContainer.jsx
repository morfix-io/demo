...
class RelinearizeCipherContainer extends PureComponent {
  constructor(props) {
    super(props)
    this.state = {
  ...
  _constructAction = () => {
    const { morfixEvaluateRelinearizeCipherRequest } = this.props

    const { cipherTextIdA, cipherTextIdDestination } = this.state

    return {
      action: morfixEvaluateRelinearizeCipherRequest,
      payload: {
        cipherTextIdA,
          ...
          >
            ...
            <Grid item>
              <TextField
                ...
                helperText={intl.formatMessage({ id: 'ciphertext_destination_description_relinearize' })}
                className={classes.textField}
            ...
            <Grid item>
              ...
              >
                <Typography variant="button" display="block">
                  {intl.formatMessage({ id: 'relinearize_a_cipher' })}
                </Typography>
              </Button>
            </Grid>
          </Grid>
...
RelinearizeCipherContainer.propTypes = {}

export default compose(withStyles(styles), withConstants, injectIntl)(RelinearizeCipherContainer)
