...
class NegateCipherContainer extends PureComponent {
  constructor(props) {
    super(props)
    this.state = {
  ...
  _constructAction = () => {
    const { morfixEvaluateNegateCipherRequest } = this.props

    const { cipherTextIdA, cipherTextIdDestination } = this.state

    return {
      action: morfixEvaluateNegateCipherRequest,
      payload: {
        cipherTextIdA,
          ...
          >
            ...
            <Grid item>
              <TextField
                ...
                helperText={intl.formatMessage({ id: 'ciphertext_destination_description_negate' })}
                className={classes.textField}
            ...
            <Grid item>
              ...
              >
                <Typography variant="button" display="block">
                  {intl.formatMessage({ id: 'negate_a_cipher' })}
                </Typography>
              </Button>
            </Grid>
          </Grid>
...
NegateCipherContainer.propTypes = {}

export default compose(withStyles(styles), withConstants, injectIntl)(NegateCipherContainer)
