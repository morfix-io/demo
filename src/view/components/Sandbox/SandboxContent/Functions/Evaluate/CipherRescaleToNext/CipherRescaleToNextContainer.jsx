...
class CipherRescaleToNextContainer extends PureComponent {
  constructor(props) {
    super(props)
    this.state = {
  ...
  _constructAction = () => {
    const { morfixEvaluateCipherRescaleToNextRequest } = this.props

    const { cipherTextIdA, cipherTextIdDestination } = this.state

    return {
      action: morfixEvaluateCipherRescaleToNextRequest,
      payload: {
        cipherTextIdA,
          ...
          >
            ...
            <Grid item>
              <TextField
                ...
                helperText={intl.formatMessage({ id: 'ciphertext_destination_description_cipher_rescale_to_next' })}
                className={classes.textField}
            ...
            <Grid item>
              ...
              >
                <Typography variant="button" display="block">
                  {intl.formatMessage({ id: 'cipher_rescale_to_next' })}
                </Typography>
              </Button>
            </Grid>
          </Grid>
...
CipherRescaleToNextContainer.propTypes = {}

export default compose(withStyles(styles), withConstants, injectIntl)(CipherRescaleToNextContainer)
